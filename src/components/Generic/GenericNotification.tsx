  ...
  return (
    ...
    >
      <div className="w-full pb-6">
        <div className="content_wrapper red_background flex w-full glass rounded-[8px] py-3 bg-primaryBlack px-4 bg-purple-950">
          <p className="w-full text-center text-base font-georgia font-500 lg:text-xl text-primaryYellow">
            {message}
          </p>
        </div>
      </div>
