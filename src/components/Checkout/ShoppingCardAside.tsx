...
const ShoppingCardAside = () => {
  ...
  const { calculateTotalPrice, calculateRemainSum, removeFromCartFullProcess } = useCheckout()
        ...
        >
          <div className="absolute right-2 top-2 z-[3]">
            <button
              ...
              onClick={() => {
                removeFromCartFullProcess(product)
              }}
            >
              <DeleteIcon />
            </button>
          ...
          <div className="w-full md:w-[70%] md:min-w-[70%] flex flex-col">
            ...
            <div className="mt-auto flex justify-between items-center px-2 py-3">
              <div className="flex justify-center items-center gap-3">
                <button
                  className="p-2 max-w-[32px] max-h-[32px] flex justify-center items-center rounded-full border-[1px] border-primaryYellow
  ...
  return (
    <aside
      className={`fixed top-0 bottom-0 right-0 w-full max-w-[500px] bg-purpleBackground z-[12] flex flex-col
