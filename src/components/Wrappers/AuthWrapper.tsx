  ...
  return (
    ...
    >
      <div className="m-auto w-fit md:py-16 relative z-[1] rounded-[24px] flex flex-col-reverse md:flex-row auth_forms">
        ...
        <div
          className={`pt-6 ${register ? 'pb-[90px]' : 'pb-6'} px-6 md:px-20 flex justify-center items-center form_container bg-purpleDark/50`}
        >
          {children}
          ...
          {register && (
            <div className="absolute z-[2] py-[2px] left-0 right-0 bottom-[0px] flex justify-center items-center">
              <p className="font-georgia font-[400] text-white text-center text-[12px] w-full max-w-[90%] mx-auto">
                ...
                и се съгласявате да споделите своето име, имейл адрес и телефон с Град на Лъжите.
              </p>
            </div>
          )}
        </div>
